...
\begin{document}
    ...
    \clearpage
    \begin{abstract}
        En el Laboratorio de Electrónica Cuántica se busca construir instrumentales ópticos capaces de observar procesos biológicos y de nanoplasmónica. Uno de estos instrumentos construidos en el Laboratorio se denomina SPIM (del inglés \textit{Selective/Single Plane Illumination Microscope}), que es capaz cuantificar procesos celulares tridimensionales.  
        ...
        En este instrumental es necesario saber el tamaño del haz a la entrada para optimizar la resolución al medir la muestra, por lo que se construyó y diseñó un perfilador con mecanismo de perfilación automático de pequeñas dimensiones para ser fácil de colocar, si desarmar el setup óptico. Este perfilador deja obsoleta la medición manual, ya que se logró mejoras substanciales en tiempo de adquisición con la misma precisión que el método manual.
